    ...
    <div className="min-h-screen bg-lightBg flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-md">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button className="w-full bg-brandGreen text-white py-2 rounded-lg text-sm font-medium hover:bg-brandGreen/90 transition">
            Register
          </button>
        </form>
        <p className="mt-4 text-center text-xs text-slate-500">
          Already have an account?{" "}
          <Link to="/admin/login" className="text-brandGreen font-medium">
            Login
          </Link>
        </p>
      </div>
